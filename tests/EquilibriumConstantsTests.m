     ...
     methods (Static)
         ...
         function calculated = calculate_individual_static(inputs)
            ...
            pH_scale_conversion = [pHScale(which_pH_scale,composition,temp_c,composition.salinity,which_ks,0.0),...
             ...
             calculated = KFunctions.pack_Ks(k0_individual,k1_individual,k2_individual,kw_individual,kb_individual,kf_individual,ks_individual,kp1_individual,kp2_individual,kp3_individual,ksi_individual,knh4_individual,kh2s_individual);
         end
