function [data,headers,nice_headers]=CO2SYS(parameter_1,parameter_2, ...
    ...
    selected_GLOBAL=(~isnan(TAc) & ~isnan(TCc) & selected_GLOBAL);
        PHic(selected_GLOBAL)                = CalculatepHfromTATC(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),TCc(selected_GLOBAL),pH_scale_in,Ks_in);
    ...
    selected_GLOBAL=(~isnan(TAc) & ~isnan(PHic) & selected_GLOBAL);
        TCc(selected_GLOBAL)                 = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
        FCic(selected_GLOBAL)                = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL),Ks_in);
        [CO3ic(selected_GLOBAL),HCO3ic(selected_GLOBAL)]   = CalculateCO3HCO3fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL),Ks_in);
    end
    ...
    selected_GLOBAL=(~isnan(TAc) & ~isnan(FCic) & selected_GLOBAL);
        PHic(selected_GLOBAL)                = CalculatepHfromTAfCO2(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),FCic(selected_GLOBAL),pH_scale_in,Ks_in);
        selected_GLOBAL=(~isnan(PHic) & selected_GLOBAL);
        if any(selected_GLOBAL)
           TCc(selected_GLOBAL)              = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
           [CO3ic(selected_GLOBAL),HCO3ic(selected_GLOBAL)]= CalculateCO3HCO3fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL),Ks_in);
    ...
    selected_GLOBAL=(~isnan(TAc) & ~isnan(HCO3ic) & selected_GLOBAL);
        PHic(selected_GLOBAL)                = CalculatepHfromTAHCO3(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),HCO3ic(selected_GLOBAL),pH_scale_in,Ks_in);  % added Peng correction // MPH
        selected_GLOBAL=(~isnan(PHic) & selected_GLOBAL);
        if any(selected_GLOBAL)
           TCc(selected_GLOBAL)              = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
           FCic(selected_GLOBAL)             = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in); 
    ...
    selected_GLOBAL=(~isnan(TAc) & ~isnan(CO3ic) & selected_GLOBAL);
        PHic(selected_GLOBAL)                 = CalculatepHfromTACO3(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),CO3ic(selected_GLOBAL),pH_scale_in,Ks_in);  % added Peng correction // MPH
        selected_GLOBAL=(~isnan(PHic) & selected_GLOBAL);
        if any(selected_GLOBAL)
           TCc(selected_GLOBAL)               = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
           FCic(selected_GLOBAL)              = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in); 
    ...
    selected_GLOBAL=(~isnan(TCc) & ~isnan(PHic) & selected_GLOBAL);
        TAc(selected_GLOBAL)                  = CalculateTAfromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in) + peng_correction_GLOBAL(selected_GLOBAL);
        FCic(selected_GLOBAL)                 = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL),Ks_in);
        [CO3ic(selected_GLOBAL),HCO3ic(selected_GLOBAL)]    = CalculateCO3HCO3fromTCpH(TCc(selected_GLOBAL), PHic(selected_GLOBAL),Ks_in);
    end
    ...
    selected_GLOBAL=(~isnan(PHic) & ~isnan(HCO3ic) & selected_GLOBAL);
        TAc(selected_GLOBAL)                  = CalculateTAfrompHHCO3(PHic(selected_GLOBAL),HCO3ic(selected_GLOBAL),pH_scale_in,Ks_in) + peng_correction_GLOBAL(selected_GLOBAL);
        TCc(selected_GLOBAL)                  = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
        FCic(selected_GLOBAL)                 = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in);
        CO3ic(selected_GLOBAL)                = CalculateCO3fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in);
    end
    ...
    selected_GLOBAL=(~isnan(PHic) & ~isnan(CO3ic) & selected_GLOBAL);
        TAc(selected_GLOBAL)                  = CalculateTAfrompHCO3(PHic(selected_GLOBAL),CO3ic(selected_GLOBAL),pH_scale_in,Ks_in) + peng_correction_GLOBAL(selected_GLOBAL);
        TCc(selected_GLOBAL)                  = CalculateTCfromTApH(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL),PHic(selected_GLOBAL),pH_scale_in,Ks_in);
        FCic(selected_GLOBAL)                 = CalculatefCO2fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in);
        HCO3ic(selected_GLOBAL)               = CalculateHCO3fromTCpH(TCc(selected_GLOBAL),PHic(selected_GLOBAL), Ks_in);
    end
    ...
    [BAlkinp(selected_GLOBAL),OHinp(selected_GLOBAL), PAlkinp(selected_GLOBAL),SiAlkinp(selected_GLOBAL),AmmAlkinp(selected_GLOBAL),...
        HSAlkinp(selected_GLOBAL), Hfreeinp(selected_GLOBAL),HSO4inp(selected_GLOBAL),HFinp(selected_GLOBAL)] = CalculateAlkParts(PHic(selected_GLOBAL),pH_scale_in,Ks_in);
    ...
    [OmegaCainp(selected_GLOBAL),OmegaArinp(selected_GLOBAL)] = CaSolubility(salinity_GLOBAL(selected_GLOBAL), temperature_in_GLOBAL(selected_GLOBAL), TCc(selected_GLOBAL), PHic(selected_GLOBAL), Ks_in);
    ...
    PHoc(selected_GLOBAL) = CalculatepHfromTATC(TAc(selected_GLOBAL)-peng_correction_GLOBAL(selected_GLOBAL), TCc(selected_GLOBAL),pH_scale_in,Ks_out); % pH is returned on the scale requested in "pHscale" (see 'constants'...)
    ...
    [BAlkout(selected_GLOBAL),OHout(selected_GLOBAL),PAlkout(selected_GLOBAL),SiAlkout(selected_GLOBAL),AmmAlkout(selected_GLOBAL),...
        HSAlkout(selected_GLOBAL), Hfreeout(selected_GLOBAL),HSO4out(selected_GLOBAL),HFout(selected_GLOBAL)] = CalculateAlkParts(PHoc(selected_GLOBAL),pH_scale_in,Ks_out);
    ...
    [OmegaCaout(selected_GLOBAL),OmegaArout(selected_GLOBAL)] = CaSolubility(salinity_GLOBAL(selected_GLOBAL), temperature_out_GLOBAL(selected_GLOBAL), TCc(selected_GLOBAL), PHoc(selected_GLOBAL), Ks_out);
...
function varargout=CalculatepHfromTATC(TAi, TCi, pH_scale_in, Ks)
    ...
    pHGuess         = CalculatepHfromTATCMunhoven(TAi, TCi, Ks);
    ln10            = log(10);
    pH              = pHGuess;
...
function varargout=CalculateTCfromTApH(TAx, pHx,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
...
function varargout=CalculatepHfromTAfCO2(TAi, fCO2i, pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
    ...
    pHGuess    = CalculatepHfromTACO2Munhoven(TAi, CO2i, Ks);
    ln10       = log(10);
    pH         = pHGuess;
...
function varargout=CalculateTAfromTCpH(TCi, pHi,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
...
function varargout=CalculateTAfrompHHCO3(pHi, HCO3i,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
...
function varargout=CalculatepHfromTAHCO3(TAi, HCO3i,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
    ...
    vl         = sum(selected_GLOBAL); % vectorlength
    % Find initital pH guess using method of Munhoven (2013)
    pHGuess    = CalculatepHfromTAHCO3Munhoven(TAi, HCO3i, Ks);
    ln10       = log(10);
    pH         = pHGuess;
    pHTol      = 0.0001; % tolerance
    deltapH    = pHTol+pH;
...
function varargout=CalculatepHfromfCO2HCO3(fCO2i, HCO3i, Ks)
    ...
    function varargout=CalculateTAfrompHCO3(pHi, CO3i,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
    [K0,K1,K2,KW,KB,KF,KS,KP1,KP2,KP3,KSi,KNH4,KH2S] = unpack_Ks(Ks);
...
function varargout=CalculatepHfromTACO3(TAi,CO3i,pH_scale_in,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL
    ...
    vl         = sum(selected_GLOBAL); % vectorlength
    % Find initital pH guess using method of Munhoven (2013)
    pHGuess    = CalculatepHfromTACO3Munhoven(TAi, CO3i, Ks);
    ln10       = log(10);
    pH         = pHGuess;
    pHTol      = 0.0001; % tolerance
    deltapH    = pHTol+pH;
...
function varargout=CalculatepHfromTATCMunhoven(TAi, TCi, Ks)
    global boron_concentration_GLOBAL selected_GLOBAL;
    [K0,K1,K2,KW,KB,KF,KS,KP1,KP2,KP3,KSi,KNH4,KH2S] = unpack_Ks(Ks);
...
function varargout=CalculatepHfromTACO2Munhoven(TAi, CO2x, Ks)
    global boron_concentration_GLOBAL selected_GLOBAL;
    [K0,K1,K2,KW,KB,KF,KS,KP1,KP2,KP3,KSi,KNH4,KH2S] = unpack_Ks(Ks);
    K1F=K1(selected_GLOBAL);     K2F=K2(selected_GLOBAL);     TBF =boron_concentration_GLOBAL(selected_GLOBAL);    KBF=KB(selected_GLOBAL);
...
function varargout=CalculatepHfromTAHCO3Munhoven(TAi, HCO3x, Ks)
    global boron_concentration_GLOBAL selected_GLOBAL;
    [K0,K1,K2,KW,KB,KF,KS,KP1,KP2,KP3,KSi,KNH4,KH2S] = unpack_Ks(Ks);
    K1F=K1(selected_GLOBAL);     K2F=K2(selected_GLOBAL);     TBF =boron_concentration_GLOBAL(selected_GLOBAL);    KBF=KB(selected_GLOBAL);
    g0 = 2.*K2F.*KBF.*HCO3x;
...
function varargout=CalculatepHfromTACO3Munhoven(TAi, CO3x, Ks)
    global boron_concentration_GLOBAL selected_GLOBAL;
...
function varargout=RevelleFactor(TAi, TCi, pH_scale,Ks)
    ...
    TCi = TC0 + dTC;
    pHc= CalculatepHfromTATC(TAi, TCi, pH_scale,Ks);
...
function varargout=CalculateAlkParts(pH,pH_scale,Ks)
    global boron_concentration_GLOBAL fluorine_concentration_GLOBAL sulphate_concentration_GLOBAL phosphate_GLOBAL silicate_GLOBAL ammonia_GLOBAL sulphide_GLOBAL selected_GLOBAL;
...
function varargout=CaSolubility(salinity_GLOBAL, TempC, TC, pH, Ks)
    global temp_k_GLOBAL log_temp_k_GLOBAL sqrt_salinity_GLOBAL Pbar which_k1_k2_constants_GLOBAL CAL selected_GLOBAL
    global k_perturbation_GLOBAL    % Id of perturbed K
